        ...
        async function saveSettingEdit() {
            ...
            try {
                const response = await fetch('../api/settings-actions.php', {
                    ...
                    body: JSON.stringify({ action: 'update_setting', settingID: parseInt(settingID), value: value, csrf_token: csrfToken })
                });
                const result = await response.json();
        ...
        async function deleteSetting(settingID, settingKey) {
            ...
            try {
                const response = await fetch('../api/settings-actions.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'delete_setting', settingID: settingID, csrf_token: csrfToken })
                });
                const result = await response.json();
