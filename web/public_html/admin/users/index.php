        ...
        async function confirmStatusChange() {
            ...
            try {
                const response = await fetch('../api/user-actions.php', {
                    ...
                    body: JSON.stringify({ action: 'update_status', userID: parseInt(userID), status: newStatus })
                });
                const result = await response.json();
        ...
        async function confirmTierChange() {
            ...
            try {
                const response = await fetch('../api/user-actions.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'update_tier', userID: parseInt(userID), tier: newTier })
                });
                const result = await response.json();
        ...
        async function unlockUser(userID, username) {
            ...
            try {
                const response = await fetch('../api/user-actions.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'unlock_user', userID: userID })
                });
                const result = await response.json();
        ...
        async function toggleSuperAdmin(userID, username, enable) {
            ...
            try {
                const response = await fetch('../api/user-actions.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'toggle_super_admin', userID: userID, enabled: enable })
                });
                const result = await response.json();
