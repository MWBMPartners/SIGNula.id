...
- Last synced: 2026-09-23 — standing rules revised; handoff kept at `HANDOFF.md` (top of the project) so any AI tool can use it.
- Working branch: `alpha` (pending owner answer Q1 in the handoff).
...
- Next queue: owner's Codex review → thorough docs update → self-hosted Swagger UI backup
  files → tidy PRs #118/#93 → sync `beta`/`release-candidate` → #94, #101.
